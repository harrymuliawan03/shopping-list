...
class _AddItemState extends State<AddItem> {
  ...
  void _onSubmit() async {
    if (_formKey.currentState!.validate()) {
      ...
      final url = Uri.https(
          'flutter-prep-a237e-default-rtdb.firebaseio.com', 'string-list.json');
      ...
      await http
        ...
        body: json.encode({
          ...
          .then(
        (value) {
          final Map<String, dynamic> response = json.decode(value.body);
          Navigator.pop(
            context,
            GroceryItem(
              id: response['name'],
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _isSend ? null : _onSubmit,
                    child: _isSend
                        ? const SizedBox(
                            height: 16,
                            width: 16,
